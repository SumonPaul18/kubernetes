...
## Step 1:
### If we Settings up Static IP and Hostname and FQDN on Node 
#### Bellow Command Run on Thats Node
    rm -rf kubernetes
...
## Step 3:
### Configured as Kubeadm Master Node (Master)  
...
Copy the <b>kubeadm join token</b> & Paste on <b>Worker Node</b>
~~~
 kubeadm join 172.30.20.20:6443 — token cdm6fo.dhbrxyleqe5suy6e \
    — discovery-token-ca-cert-hash sha256:1fc51686afd16c46102c018acb71ef9537c1226e331840e7d401630b96298e7d
~~~
