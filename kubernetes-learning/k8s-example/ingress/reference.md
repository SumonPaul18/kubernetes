https://github.com/oleg-nefedov/kubernetes-ingress-nginx-tutorial?tab=readme-ov-file
...
- [*Best* Using Metal LB on a bare-metal(OnPrem) Kubernetes Setup](https://medium.com/tektutor/using-metal-lb-on-a-bare-metal-onprem-kubernetes-setup-6d036af1d20c)
